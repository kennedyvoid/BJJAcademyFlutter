          ...
          return ListView(
            ...
            children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        FittedBox(
                          ...
                          child: Text('Jiupedia', style: TextStyle(fontSize: 25, fontWeight: FontWeight.w900, letterSpacing: .3)),
                        ),
              ...
              GridView.count(
                ...
                children: [
                  _HomeAction(icon: Icons.sports_martial_arts, title: 'Posições', subtitle: 'por faixa', onTap: () {}),
                  _HomeAction(icon: Icons.block, title: 'Proibidas', subtitle: 'por faixa', onTap: () => context.push('/rules')),
                  _HomeAction(icon: Icons.favorite, title: 'Favoritos', subtitle: 'salvos', onTap: () => context.push('/favorites')),
                  _HomeAction(icon: Icons.menu_book, title: 'Regras', subtitle: 'oficiais', onTap: () => context.push('/rules')),
                ],
              ),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 14, height: 1.0),
                    ),
